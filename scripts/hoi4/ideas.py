...
out.write(pyradox.table.make_table(result, 'wiki', columns, sort_function = lambda key, value: value['country'], table_style = None))
out.close()
...
out.write(pyradox.table.make_table(trait_result, 'wiki', trait_columns, sort_function = lambda key, value: value['name'], table_style = None))
out.close()
